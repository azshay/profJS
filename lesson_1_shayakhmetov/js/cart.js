...
const renderGoodsItem = (title, price, src_image, size = "S") => {
    ...
    <div class="cart__card__descr">
         ...
         <p class="cart__card__size">Size: ${size}</p>
...
const renderGoodsList = (list) => {
     let goodsList = list
          .map((item) =>
               renderGoodsItem(item.title, item.price, item.src_image)
          )
          .join("");
     ...
     document.querySelector(".cart__products-cards").innerHTML = goodsList;
};
